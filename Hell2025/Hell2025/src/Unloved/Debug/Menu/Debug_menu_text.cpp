...
namespace Debug::Menu::Text {
    ...
    PageId g_playerInteractInfoPage = ROOT_PAGE_ID;
    ...
    void DisplayPlayerInteractInfo();
    ...
    void RegisterMenu() {
        ...
        g_playerInteractInfoPage = RegisterDisplayPage(g_homePage, DisplayPlayerInteractInfo);
    ...
    void BuildMainMenu() {
        ...
        AddSubMenu(static_cast<uint32_t>(Setting::PLAYER_INTERACT_INFO), "Player interact info", g_playerInteractInfoPage);
    ...
    void DisplayPlayerInteractInfo() {
        Debug::SetDebugTextMode(DebugTextMode::PER_PLAYER_INTERACT_INFO);
    }
