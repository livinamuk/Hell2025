...
namespace Unloved {
    ...
    struct Snake {
        Snake() = default;
        Snake(uint64_t id, SnakeCreateInfo createInfo, SpawnOffset spawnOffset = SpawnOffset());

        void Init(uint64_t id, SnakeCreateInfo createInfo, SpawnOffset spawnOffset = SpawnOffset());
        ...
        const SnakeCreateInfo& GetCreateInfo() const { return m_createInfo; }
