...
namespace Unloved {
    ...
    void Shark::PlayAnimation(Bible::AnimationSlot animationSlot, float speed) {
        SkinnedGameObject* skinnedGameObject = GetSkinnedGameObject();
        ...
        animatorInstance->PlayAnimation(m_animationLayerIndex, Bible::GetAnimation(Bible::AnimationProfile::SHARK, animationSlot), speed);
    }

    void Shark::PlayAndLoopAnimation(Bible::AnimationSlot animationSlot, float speed) {
        SkinnedGameObject* skinnedGameObject = GetSkinnedGameObject();
        AnimatorInstance* animatorInstance = Animator::GetAnimatorInstanceByObjectId(m_animatorInstanceId);
        if (!skinnedGameObject) return;
        if (!animatorInstance) return;
        ...
        skinnedGameObject->SetAnimationModeToAnimated();
        animatorInstance->PlayAndLoopAnimation(m_animationLayerIndex, Bible::GetAnimation(Bible::AnimationProfile::SHARK, animationSlot), speed);
    }
