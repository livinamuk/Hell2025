...
namespace Unloved {
    ...
    void Player::PlayViewWeaponAnimation(Bible::AnimationSlot animationSlot, float speed) {
    ...
    void Player::PlayAndLoopViewWeaponAnimation(Bible::AnimationSlot animationSlot, float speed) {
        WeaponInfo* weaponInfo = GetCurrentWeaponInfo();
        SkinnedGameObject* viewWeapon = GetViewWeaponSkinnedGameObject();
        AnimatorInstance* animatorInstance = Animator::GetAnimatorInstanceByObjectId(m_viewWeaponAnimatorInstanceId);
    ...
    void Player::PlayCharacterWeaponAnimation(Bible::AnimationSlot animationSlot) {
        m_animatedHumanoid.PlayCharacterWeaponAnimation(animationSlot);
    }

    void Player::PlayAndLoopCharacterWeaponAnimation(Bible::AnimationSlot animationSlot) {
        m_animatedHumanoid.PlayAndLoopCharacterWeaponAnimation(animationSlot);
    }
