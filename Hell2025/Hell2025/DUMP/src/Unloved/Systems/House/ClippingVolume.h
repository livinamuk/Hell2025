...
struct ClippingVolume {
    ...
    void SetOwner(ObjectType objectType, uint64_t objectId);
    ...
    const ObjectType GetOwnerObjectType() const       { return m_ownerObjectType; }
...
private:
    ...
    ObjectType m_ownerObjectType = ObjectType::UNDEFINED;
